...
test("TC_20_To_Verify_that_Reset_button_functionality_on_Camp_Cluster_Data_Search_Filter_page", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/TestScripts/DigitEYESCampsCluster/DigitEYESDataLoader/DataForSalesForce/TC_20_To_Verify_that_Reset_button_functionality_on_Camp_Cluster_Data_Search_Filter_page.ds"
  });
