...
test("To_Verify_That_Pre-Screening_Examination_Ophthalm_And_Dispense_Icons_Should_Be_Displayed_In_Participants_Page", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq2/Test Scripts/Camp Server/Camp_Server_India/Participants/To_Verify_That_Pre-Screening_Examination_Ophthalm_And_Dispense_Icons_Should_Be_Displayed_In_Participants_Page.ds"
  });
