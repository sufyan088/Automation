...
test("TS_05_To_verify_that_Go_to_next_page_button_is_functional", async ({ page }) => {
  const data = loadRuntimeData();
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Customer_Management_Admin/TS_05_To_verify_that_Go_to_next_page_button_is_functional.ds"
  });
