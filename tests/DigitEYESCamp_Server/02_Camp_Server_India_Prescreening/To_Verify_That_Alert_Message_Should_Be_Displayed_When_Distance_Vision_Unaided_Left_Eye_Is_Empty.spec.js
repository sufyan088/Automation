...
test("To_Verify_That_Alert_Message_Should_Be_Displayed_When_Distance_Vision_Unaided_Left_Eye_Is_Empty", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq2/Test Scripts/Camp Server/Camp_Server_India/Prescreening/To_Verify_That_Alert_Message_Should_Be_Displayed_When_Distance_Vision_Unaided_Left_Eye_Is_Empty.ds"
  });
