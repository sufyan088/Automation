...
test("TS_07_To_verify_that_Pagination_button_is_functional", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/imREmit_Dashboard_New/Bank_reconciliation_file_not_received/TS_07_To_verify_that_Pagination_button_is_functional.ds"
  });
