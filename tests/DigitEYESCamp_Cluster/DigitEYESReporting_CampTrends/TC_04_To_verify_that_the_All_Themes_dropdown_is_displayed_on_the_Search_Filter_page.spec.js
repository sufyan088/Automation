...
test("TC_04_To_verify_that_the_All_Themes_dropdown_is_displayed_on_the_Search_Filter_page", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/TestScripts/DigitEYESCampsCluster/DigitEYESReporting/CampTrends/TC_04_To_verify_that_the_All_Themes_dropdown_is_displayed_on_the_Search_Filter_page.ds"
  });
