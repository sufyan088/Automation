...
test("TS_07_To_Verify_that_the_Payment_Status_filter_is_functional_on_the_Adjust_Filters_popup", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/MGMT_Information_System/TS_07_To_Verify_that_the_Payment_Status_filter_is_functional_on_the_Adjust_Filters_popup.ds"
  });
