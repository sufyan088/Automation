...
test("TS_34_verify_user_clicks_on_Update_Sub_then_proceeds_to_remove_SR_then_Sub_removed_from_Sub_col", async ({ page }) => {
  ...
  await test.step('Run converted flow', async () => {
    await customerModuleManagementAdminModuleNewHelpers.runScenario(page, data, 'TS_34_verify_user_clicks_on_Update_Sub_then_proceeds_to_remove_SR_then_Sub_removed_from_Sub_col');
  });
