...
test("TS_65_To_verify_that_hover_over_tool_tip_matches_configured_canned_message_content_exactly", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/SR_Search_New_Module/TS_65_To_verify_that_hover_over_tool_tip_matches_configured_canned_message_content_exactly.ds"
  });
