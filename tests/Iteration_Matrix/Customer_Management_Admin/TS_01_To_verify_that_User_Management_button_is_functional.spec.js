...
test("TS_01_To_verify_that_User_Management_button_is_functional", async ({ page }) => {
  const data = loadRuntimeData();
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Customer_Management_Admin/TS_01_To_verify_that_User_Management_button_is_functional.ds"
  });
  ...
  await test.step('Open User Management page', async () => {
    ...
    await customerManagementAdminHelpers.verifySectionVisible(page, 'userManagement');
  });
