...
Camp Server is now documented separately in `vision-spring-camp-server-handoff.md` because it is a separate `source-aiq2` intake track, not part of the fully converted `source-aiq/TestScripts/DigitEYESCampsCluster` family.
