...
test("TS_95_To_verify_when_imREmit_Lite_is_selected_from_module_selection_Bank_dropdown_field_is_visible", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Customer_Management_Admin_NM/TS_95_To_verify_when_imREmit_Lite_is_selected_from_module_selection_Bank_dropdown_field_is_visible.ds"
  });
