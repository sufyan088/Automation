...
test("TS_38_To_verify_user_click_Update_Sub_and_remove_SR_and_DP_then_Sub_removed_from_Self_Funding_Column", async ({ page }) => {
  ...
  await test.step('Run converted flow', async () => {
    await customerModuleManagementAdminTwoHelpers.runScenario(page, data, 'TS_38_To_verify_user_click_Update_Sub_and_remove_SR_and_DP_then_Sub_removed_from_Self_Funding_Column');
  });
