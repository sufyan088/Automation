...
test("To_Verify_That_All _Diagnosis_Should_Be_UnChecked_When_Normal_No_Refractive_Error_Checkbox_Is_Checked", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq2/Test Scripts/Camp Server/Camp_Server_India/Examination/To_Verify_That_All _Diagnosis_Should_Be_UnChecked_When_Normal_No_Refractive_Error_Checkbox_Is_Checked.ds"
  });
