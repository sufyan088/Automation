...
test("TS_13_To_verify_that_the_previous_button_In_Viewing_Payment_Page_is_functional", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/imREmit_Dashboard/Failed_payments_on_IM_IM_ERROR/TS_13_To_verify_that_the_previous_button_In_Viewing_Payment_Page_is_functional.ds"
  });
