...
test("TS_130_To_verify_that_the_payment_statuses_are_showing_according_to_the_program_type_for_Payments_Received", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/MGMT_Information_System/TS_130_To_verify_that_the_payment_statuses_are_showing_according_to_the_program_type_for_Payments_Received.ds"
  });
