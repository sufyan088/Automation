...
test("TS_44_To_verify_that_if_User_selects_Duplicate_Payments_then_show_Funding_Options_field", async ({ page }) => {
  const data = loadRuntimeData();
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Customer_Management_Admin_New/TS_44_To_verify_that_if_User_selects_Duplicate_Payments_then_show_Funding_Options_field.ds"
  });
