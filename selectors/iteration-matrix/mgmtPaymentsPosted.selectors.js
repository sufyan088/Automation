const mgmtPaymentsPostedSelectors = {
  navigation: {
    ...
    paymentsPostedTab: [
      { type: 'role', role: 'tab', options: { name: 'Payments Posted', exact: true }, name: 'payments posted tab' },
      { type: 'text', value: 'Payments Posted', options: { exact: true }, name: 'payments posted text' }
    ],
    paymentsPostedHeading: [
      { type: 'role', role: 'heading', options: { name: 'MIS Payments Posted', exact: true }, name: 'payments posted heading' },
      { type: 'text', value: 'MIS Payments Posted', options: { exact: true }, name: 'payments posted heading text' }
    ]
  },
  page: {
    graphHeading: [
      { type: 'role', role: 'heading', options: { name: 'Payments Posted Graph', exact: true }, name: 'graph heading' },
      { type: 'text', value: 'Payments Posted Graph', options: { exact: true }, name: 'graph heading text' }
    ],
    adjustFiltersButton: [
    ...
    tableHeading: [
      { type: 'role', role: 'heading', options: { name: 'Payments Posted Table', exact: true }, name: 'table heading' },
      { type: 'text', value: 'Payments Posted Table', options: { exact: true }, name: 'table heading text' }
    ],
    tableElement: [
      { type: 'custom', name: 'payments posted table', factory: (page) => page.locator('#table-container table').first() },
