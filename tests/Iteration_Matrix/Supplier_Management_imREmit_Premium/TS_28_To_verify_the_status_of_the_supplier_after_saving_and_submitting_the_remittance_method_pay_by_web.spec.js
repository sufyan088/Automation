...
test("TS_28_To_verify_the_status_of_the_supplier_after_saving_and_submitting_the_remittance_method_pay_by_web", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Supplier_Management_imREmit_(Premium)/TS_28_To_verify_the_status_of_the_supplier_after_saving_and_submitting_the_remittance_method_pay_by_web.ds"
  });
