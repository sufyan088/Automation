...
test("TS_42_To_verify_that_status_button_is_functional", async ({ page }) => {
  const data = loadRuntimeData();
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Supplier_Management_imREmit_(Premium)/TS_42_To_verify_that_status_button_is_functional.ds"
  });
