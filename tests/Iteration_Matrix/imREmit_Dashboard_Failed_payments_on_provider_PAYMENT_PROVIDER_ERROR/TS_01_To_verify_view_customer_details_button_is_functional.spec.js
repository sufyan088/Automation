...
test("TS_01_To_verify_view_customer_details_button_is_functional", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/imREmit_Dashboard/Failed_payments_on_provider_PAYMENT_PROVIDER_ERROR/TS_01_To_verify_view_customer_details_button_is_functional.ds"
  });
