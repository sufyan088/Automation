...
test("To_Verify_That_Next_Button_Should_Be_Displayed_When_VS_Glasses_Taking_Button_Is_Clicked", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq2/Test Scripts/Camp Server/Camp_Server_India/Dispense/To_Verify_That_Next_Button_Should_Be_Displayed_When_VS_Glasses_Taking_Button_Is_Clicked.ds"
  });
