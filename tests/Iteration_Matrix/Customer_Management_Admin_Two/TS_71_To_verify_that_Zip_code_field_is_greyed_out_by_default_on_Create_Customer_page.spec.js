...
test("TS_71_To_verify_that_Zip_code_field_is_greyed_out_by_default_on_Create_Customer_page", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Customer_Management_Admin_Two/TS_71_To_verify_that_Zip_code_field_is_greyed_out_by_default_on_Create_Customer_page.ds"
  });
