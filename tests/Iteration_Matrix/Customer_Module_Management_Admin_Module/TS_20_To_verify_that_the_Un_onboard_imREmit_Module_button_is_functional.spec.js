...
test("TS_20_To_verify_that_the_Un_onboard_imREmit_Module_button_is_functional", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Customer_Module_Management_Admin_Module/TS_20_To_verify_that_the_Un_onboard_imREmit_Module_button_is_functional.ds"
  });
