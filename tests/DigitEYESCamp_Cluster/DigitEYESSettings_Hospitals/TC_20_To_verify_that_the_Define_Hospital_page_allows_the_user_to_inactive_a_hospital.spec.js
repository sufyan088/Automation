...
test("TC_20_To_verify_that_the_Define_Hospital_page_allows_the_user_to_inactive_a_hospital", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/TestScripts/DigitEYESCampsCluster/DigitEYESSettings/Hospitals/TC_20_To_verify_that_the_Define_Hospital_page_allows_the_user_to_inactive_a_hospital.ds"
  });
