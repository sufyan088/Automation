...
test("TS_21_To_verify_that_the_Exclude_character_criteria_setting_can_be_added", async ({ page }) => {
  const data = loadRuntimeData();
  const criteriaValue = `exc-${Date.now()}`;
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Criteria_Settings/TS_21_To_verify_that_the_Exclude_character_criteria_setting_can_be_added.ds"
  });
  ...
  await test.step('Add Exclude character criteria', async () => {
