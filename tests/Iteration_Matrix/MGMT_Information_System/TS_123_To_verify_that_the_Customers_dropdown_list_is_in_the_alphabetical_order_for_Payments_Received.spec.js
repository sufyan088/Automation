...
test("TS_123_To_verify_that_the_Customers_dropdown_list_is_in_the_alphabetical_order_for_Payments_Received", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/MGMT_Information_System/TS_123_To_verify_that_the_Customers_dropdown_list_is_in_the_alphabetical_order_for_Payments_Received.ds"
  });
