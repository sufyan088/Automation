...
test("TS_19_To_verify_that_the_General_Information_button_In_Viewing_Payment_Page_is_functional", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/imREmit_Dashboard/Payables_Missed_in_THE_PAST_30_DAYS/TS_19_To_verify_that_the_General_Information_button_In_Viewing_Payment_Page_is_functional.ds"
  });
  ...
  await test.step('Open general information in payment details', async () => {
    await imremitDashboardPayablesMissedInThePast30DaysHelpers.clickDetailButton(
      page,
      imremitDashboardPayablesMissedInThePast30DaysHelpers.selectors.detail.generalInformation
    );
  });
