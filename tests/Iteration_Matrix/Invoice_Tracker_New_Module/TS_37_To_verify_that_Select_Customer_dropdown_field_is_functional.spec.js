...
test("TS_37_To_verify_that_Select_Customer_dropdown_field_is_functional", async ({ page }) => {
  const data = loadRuntimeData();
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/Invoice_Tracker_New_Module/TS_37_To_verify_that_Select_Customer_dropdown_field_is_functional.ds"
  });
