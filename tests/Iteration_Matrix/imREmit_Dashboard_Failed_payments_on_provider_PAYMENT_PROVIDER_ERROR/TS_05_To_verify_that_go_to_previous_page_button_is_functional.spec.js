...
test("TS_05_To_verify_that_go_to_previous_page_button_is_functional", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq/Test Scripts/imREmit_Dashboard/Failed_payments_on_provider_PAYMENT_PROVIDER_ERROR/TS_05_To_verify_that_go_to_previous_page_button_is_functional.ds"
  });
