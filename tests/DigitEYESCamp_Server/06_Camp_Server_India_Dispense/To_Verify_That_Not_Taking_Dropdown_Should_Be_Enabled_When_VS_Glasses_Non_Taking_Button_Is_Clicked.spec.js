...
test("To_Verify_That_Not_Taking_Dropdown_Should_Be_Enabled_When_VS_Glasses_Non_Taking_Button_Is_Clicked", async ({ page }) => {
  ...
  test.info().annotations.push({
    type: 'source-aiq',
    description: "source-aiq2/Test Scripts/Camp Server/Camp_Server_India/Dispense/To_Verify_That_Not_Taking_Dropdown_Should_Be_Enabled_When_VS_Glasses_Non_Taking_Button_Is_Clicked.ds"
  });
